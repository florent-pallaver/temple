...
import com.temple.util.json.GenericStringHandler;
...
//	@JsonField
//	@Column(nullable = false, length = 200, insertable = false, updatable = false)
//	private String asciiname;
	...
	@JsonField(handler = GenericStringHandler.class)
...
//	@JsonField
	...
	@JsonField(handler = GenericStringHandler.class, inputable = false)
	@Column(nullable = false)
...
//	@JsonField(handler = IntegerHandler.class)
	...
	private Geoname(String[] tuple) {
		this(Integer.parseInt(tuple[0]),
				tuple[1],
//				tuple[2],
				Double.parseDouble(tuple[4]),
				Double.parseDouble(tuple[5]),
//				tuple[6],
				parseFeature(tuple[7]),
				Country.getByISOCode(tuple[8], false),
//				tuple[9],
				tuple[10],
				tuple[11],
				tuple[12],
	...
	private Geoname(int geonameid, String name, double latitude, double longitude,
			Feature feature, Country country, String admin1_code, String admin2_code,
...
//		this.cc2 = cc2;
	...
	public Timestamp getCreationTS() {
		if (ts == null) {
			ts = new Timestamp(this.modification_date.getTimeInMillis());
		}
		return this.ts;
	}
