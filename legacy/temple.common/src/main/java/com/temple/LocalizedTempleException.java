...
public class LocalizedTempleException extends AbstractTempleException {
	 ...
	 * @param lv
	 * @param language
	 *            - the language to use to create the localized messages of this
	 *            exception.
	 * @param detailed
	 */
	 ...
	 *            exception.
	 * @param detailed
	 *            - <code>true</code> if a detailed message should be set,
	...
	protected LocalizedTempleException(Throwable cause) {
