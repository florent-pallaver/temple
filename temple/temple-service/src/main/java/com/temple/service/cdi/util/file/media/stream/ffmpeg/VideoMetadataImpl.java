...
import com.temple.util.file.media.stream.EmptyAudioStreamMetadata;
...
final class VideoMetadataImpl extends AbstractStreamMetadata implements VideoMetadata {
	...
	VideoMetadataImpl(FFProbeMetadata ffp) {
		...
		this.audioStreamMetadata = ffp.streams.audio != null ? new AudioStreamMetadataImpl(ffp) : EmptyAudioStreamMetadata.INSTANCE;
	}
