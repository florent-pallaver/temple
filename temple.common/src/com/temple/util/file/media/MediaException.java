...
public abstract class MediaException extends LocaleViewableTempleException {
	...
	protected MediaException(Object[] parameters, Module module, Throwable cause) {
		super(parameters, module, cause);
	}

	protected MediaException(Object[] parameters, Module module) {
		super(parameters, module);
	}

	protected MediaException(String keySuffix, Object[] parameters, Module module, Throwable cause) {
		super(keySuffix, parameters, module, cause);
	}

	protected MediaException(String keySuffix, Object[] parameters, Module module) {
