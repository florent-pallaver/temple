...
/**
 * Base contract to defines an interval. <br>
 * It is implementation specific to define if the boundaries are included or
 * not.
 *
 * @author flominou
 * @param <D>
...
public interface Interval<D extends Comparable<D>> {
	 ...
	 *
	 * @return <code>true</code> if the lower limit is included in this
	 ...
	 * Default implementation always returns <code>true</code>.
	 *
	 * @return <code>true</code> if the upper limit is included in this
	 *         interval, <code>false</code> otherwise.
	 */
	 ...
	 * @param point
	 *            a point
	 * @return <code>true</code> if the point is inside this interval,
	 *         <code>false</code> otherwise.
	 * @throws NullPointerException
	 *             if point is <code>null</code>.
	 */
	...
	/**
	 * @return <code>true</code> if at least one boundary is defined,
	 *         <code>false</code> if no boundaries are.
	 */
